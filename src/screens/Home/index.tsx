...
const data = [
  ...
  { id: "2", name: "glass_of_milk", expires: "Sep 7, 2025", qty: 2, icon: "🥛" },
  { id: "3", name: "broccoli", expires: "Sep 2, 2024", qty: 1, icon: "🥦" },
  { id: "4", name: "cheese_wedge", expires: "Aug 15, 2024", qty: 1, icon: "🧀", expired: true },
];
          ...
          <View style={[styles.card, item.expired && styles.expiredCard]}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={[styles.itemDate, item.expired && styles.expiredText]}>
                {item.expired ? `Expired: ${item.expires}` : `Expires: ${item.expires}`}
              </Text>
            </View>
